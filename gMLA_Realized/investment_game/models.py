...
class Constants(BaseConstants):
    ...
    players_per_group = 2
    individual_rounds = 4
    individual_rounds_2 = 4
    group_rounds = 4
    num_rounds = individual_rounds + group_rounds + individual_rounds_2
...
class Subsession(BaseSubsession):
    def creating_session(self):
        ...
        for p in self.get_players():
            p.is_individual_round = self.round_number <= Constants.individual_rounds or (
                        Constants.individual_rounds + Constants.group_rounds < self.round_number <= Constants.individual_rounds + Constants.group_rounds + Constants.individual_rounds_2)
